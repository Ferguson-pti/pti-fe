...
<template>
    <section class="w-full py-20 px-16 bg-custom-green flex flex-col items-center justify-center font-lexend">
        <div class="p-10 border- border-white rounded-lg">
            <h1 class="text-7xl text-white w-[55%] mb-6 font-medium">Featured Speakers</h1>

            <p class="text-custom-grey w-[55%] mt-4 font-light text-lg">
