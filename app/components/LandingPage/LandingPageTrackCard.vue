...
<template>
  <div class="group relative bg-white md:w-[95%] lg:w-auto p-6 md:p-8 lg:px-10 xl:p-14 h-[550px] lg:mr-8 rounded-lg mb-2">
    ...
    <p class="mt-4 md:mt-8 text-sm md:text-base font-light z-10 group-hover:text-custom-red duration-300 leading-6 md:leading-7">
      <span class="flex xl:hidden">{{ wordMinimizer(body, 60) }}</span>
      <span class="hidden xl:flex">{{ body }}</span>
    </p>
  </div>
</template>
