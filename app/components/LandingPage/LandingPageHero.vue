  ...
  <AppSectionWrapper>
    ...
    >
      <div class="flex flex-col items-start justify-start w-full lg:w-[55%] bg-custom-green px-4 md:px-10 py-6 md:py-10 rounded-lg z-10">
        ...
        <NuxtImg
          src="ptdfbuilding.jpg"
          provider="sirv"
          class="mt-6 flex lg:hidden w-full bg-custom-grey rounded-lg"
        />

        <span class="font-lexend text-base 2xl:text-xl mt-6 text-custom-grey">
        ...
        <AppConferenceCountdown
          ...
          title-class="w-full text-center md:text-left mt-6 md:mt-10 mb-3 text-base text-custom-gold font-medium font-lexend"
          ...
          number-size="text-2xl md:text-4xl"
